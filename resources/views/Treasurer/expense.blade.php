            ...
            <x-two-table-scrollable>
                <thead>
                    <tr class="bg-white border border-black">
                        <th class="p-2 border border-black text-white text-center bg-[#1a4d2e]">DATE</th>
                ...
                <tbody x-data="{ selectedDate: null }">
                    @foreach($groupedExpenses as $date => $expensesForDate)
                        ...
                        <td class="p-2 border border-black text-right"> ₱{{ number_format($totalAmountForDate, 2) }}
                        </td>
                    </tr>
                    @endforeach
                </tbody>
                <tfoot>
                    <tr>
                        ...
                        <td class="p-2 border border-black font-bold text-right text-white">

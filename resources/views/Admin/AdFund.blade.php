    ...
    <x-trea-components.sidebar :profile="$profile" :firstname="$firstname" :lastname="$lastname">
        <div class="mt-4">
            ...
            <x-trea-components.nav-link>
                ...
                <a href="/admin/fund" class="text-[15px] sm:text-[17px] font-semibold text-[#1a4d2e] border-b-2 border-[#1a4d2e] pb-1">Funds</a>
            </x-trea-components.nav-link>
                ...
                <div class="w-full">
                    ...
                    <div id="printArea">
                        <table class="mt-4 w-full table-fixed border border-black">
                            <thead>
                                <tr class="bg-[#1a4d2e] text-center">
                                    <th class="p-2 border border-black [#1a4d2e] text-white">DESCRIPTION</th>

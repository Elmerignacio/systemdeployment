...
<div id="Adduser" class="fixed inset-0 flex items-center justify-center hidden z-50">
...
document.addEventListener("DOMContentLoaded", function () {
    const archiveModal = document.getElementById("Adduser"); // confirmation modal
    ...
    addUserBtn.addEventListener("click", function () {
        if (form.checkValidity()) {
            ...
            form.reportValidity(); // show built-in HTML5 validation
        }
    });

    // When user clicks confirm inside confirmation modal
    ...
    // Final confirmation submits the form

...
<div class="flex h-screen overflow-auto md:overflow-hidden">
  <aside
    ...
    <nav class="mt-10 px-4 space-y-4 text-[15px] font-semibold text-white">
        ...
        <!-- Profile Section -->
    <a href="/admin/userDetails" class="flex items-center gap-4 p-2 hover:bg-green-700 rounded-lg transition-all">
        <input
            type="image"
    ...
    <script>
        ...
        @php
            $navItems = [
                ...
                ['href' => '/admin/studentBalance', 'icon' => 'fas fa-user-graduate', 'label' => 'STUDENT BALANCES'],
                ['href' => '/admin/remitted', 'icon' => 'fas fa-wallet', 'label' => 'COLLECTIONS'],
                ['href' => '/admin/payableManagement', 'icon' => 'fas fa-file-invoice-dollar', 'label' => 'PAYABLE MANAGEMENT'],
                ['href' => '/admin/expense', 'icon' => 'fas fa-money-check-alt', 'label' => 'EXPENSES'],
                ['href' => '/admin/report', 'icon' => 'fas fa-chart-pie', 'label' => 'REPORTS'],
                ['href' => '/admin/manageUser', 'icon' => 'fas fa-users-cog', 'label' => 'USER MANAGEMENT'],
            ];
        @endphp
